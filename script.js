...
//rodar os comandos de git:
//configurar usuario e email
// conf user.name seu usuario
// git conf user.emael 'seu email'
//criar um repositorio no git hubgit remote add origin https://github.com/xandale/cineSenai.git